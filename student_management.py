...
class Student:
          ...
          def __init__(self,root):
                    ...
                    def addData():
                              if(len(StdId.get())!=0):
                                  c=stdDatabase_BackEnd.addStdRec(StdId.get(),Fristname.get(),surname.get(),DoB.get(),Age.get(),Gender.get(),Address.get(),Mobile.get())
                                  print(c)
                              if c=="hi":
                                        tkinter.messagebox.showerror("Student Database Management System","User Already Present ")
                              else:
                    ...
                    def DeleteData():
                              if(len(StdId.get())!=0):
                                        c=stdDatabase_BackEnd.deleteRec(sd[0])
                                        clearData()
                                        DisplayData()
                    ...
                    self.txtStdId = Entry(DataFrameLEET,font=('arial',20,'bold'),textvariable=StdId,width=39)
